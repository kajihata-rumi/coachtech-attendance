    ...
    <main class="admin-staff-attendance">
        <div class="admin-staff-attendance__inner">
            ...
            <div class="admin-staff-attendance__month-nav">
                <a
                    href="{{ route('admin.attendance.staff', ['id' => $staff->id, 'month' => $currentMonth->copy()->subMonth()->format('Y-m')]) }}">
                    ← 前月
                </a>

                <div class="admin-staff-attendance__month">
                    <img class="admin-staff-attendance__calendar-icon" src="{{ asset('images/calendar-icon.png') }}"
                        alt="カレンダーアイコン">
                    <strong>{{ $currentMonth->format('Y/m') }}</strong>
                </div>

                <a
                    href="{{ route('admin.attendance.staff', ['id' => $staff->id, 'month' => $currentMonth->copy()->addMonth()->format('Y-m')]) }}">
                    翌月 →
                </a>
            </div>
            ...
            <div class="admin-staff-attendance__csv">
                <a class="admin-staff-attendance__csv-button"
