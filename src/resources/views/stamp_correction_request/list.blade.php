@extends(($isAdmin ?? false) ? 'layouts.admin' : 'layouts.user')
...
@section('content')
    ...
    <main>
        ...
        <div class="correction-request__tabs">
            <a class="correction-request__tab {{ request('tab', 'pending') === 'pending' ? 'is-active' : '' }}"
                href="{{ url('/stamp_correction_request/list?tab=pending') }}">
                承認待ち
            </a>

            <a class="correction-request__tab {{ request('tab') === 'approved' ? 'is-active' : '' }}"
                    ...
                    <td>
                        ...
                        @else
                            <a class="table-detail-link"
                                href="{{ route('attendance.show', ['attendance' => $request->attendance_id]) }}">
                                詳細
                            </a>
                        @endif
                    </td>
